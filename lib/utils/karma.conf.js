...
const getFilesFromGlobForTests = require( './gettestfiles.js' ).getFilesFromGlobForTests;
...
module.exports = function getKarmaConfig( options ) {
	...
	// Get files list to tests.
	const files = getFilesFromGlobForTests( options.files );
	...
	const karmaConfig = {
		...
		webpack: getWebpackConfig( Object.assign( {
			test: true
		}, options ) ),
